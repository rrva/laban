...
this primarily benefits shells/tools configured to send it.

## Consequences

- A shell that reports OSC 7 gets accurate, lag-free cwd for new tabs, the tab
  path, branch resolution, and restore — even while a subprocess is foreground.

...
instant the mouse leaves the row or the setting/renderer changes. When the
same panel is raised by keyboard hold-to-peek instead of mouse hover
(Milestone 8), it centers in the terminal pane rather than sitting beside the
row — there is no cursor position to anchor beside during a keyboard switch,
and the user is looking at the terminal pane they're about to land in, not
the sidebar.

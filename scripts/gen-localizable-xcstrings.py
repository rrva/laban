...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "Background blur:": {
        ...
        "es": "Desenfoque del fondo:",
        "hi": "पृष्ठभूमि धुंधलापन:",
        "ru": "Размытие фона:",
    },
    "Background blur": {
        "zh-Hans": "背景模糊",
    ...
    "Background blur: %lld percent": {
        ...
        "ja": "背景のぼかし：%lld%%",
        "ko": "배경 흐림: %lld%%",
        "fr": "Flou de l’arrière-plan : %lld %%",
        "es": "Desenfoque del fondo: %lld %%",
        "hi": "पृष्ठभूमि धुंधलापन: %lld प्रतिशत",
        "ru": "Размытие фона: %lld %%",
    },
    "Choose how strongly macOS blurs content behind the terminal. 0% shows the content directly; 100% applies the strongest available window blur.": {
        "zh-Hans": "选择 macOS 对终端后方内容的模糊强度。0% 直接显示内容；100% 应用最强的窗口模糊。",
        "zh-Hant": "選擇 macOS 對終端機後方內容的模糊強度。0% 直接顯示內容；100% 套用最强的視窗模糊。",
        "ja": "ターミナルの背後にあるコンテンツを macOS がどの程度ぼかすかを選択します。0% ではそのまま表示し、100% では利用可能な最も強いウィンドウぼかしを適用します。",
        "ko": "macOS가 터미널 뒤 콘텐츠를 얼마나 흐리게 할지 선택합니다. 0%는 콘텐츠를 그대로 표시하고 100%는 사용 가능한 가장 강한 창 흐림을 적용합니다.",
        "fr": "Choisissez l’intensité du flou appliqué par macOS au contenu situé derrière le terminal. 0 % l’affiche directement ; 100 % applique le flou de fenêtre le plus fort disponible.",
        "es": "Elige con qué intensidad macOS desenfoca el contenido detrás del terminal. 0 % lo muestra directamente; 100 % aplica el desenfoque de ventana más fuerte disponible.",
        "hi": "चुनें कि macOS टर्मिनल के पीछे की सामग्री को कितना धुंधला करे। 0% सामग्री को सीधे दिखाता है; 100% सबसे मजबूत उपलब्ध विंडो धुंधलापन लागू करता है।",
        "ru": "Выберите, насколько сильно macOS размывает содержимое за терминалом. 0 % показывает его напрямую; 100 % применяет самое сильное доступное размытие окна.",
    },
    ...
    "The selected theme could not be removed.": {},
    "Font:": {
        "zh-Hans": "字体：",
        "zh-Hant": "字體：",
        "ja": "フォント：",

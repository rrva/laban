...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "What programs see": {
        ...
        "ja": "プログラムから見える情報",
        "ko": "프로그램에 보이는 정보",
        "fr": "Ce que voient les programmes",
        "es": "Lo que ven los programas",
        "hi": "प्रोग्राम क्या देखते हैं",
        "ru": "Что видят программы",
    },
    "Credits": {
        "zh-Hans": "致谢",
        "zh-Hant": "致謝",
    ...
    "Run Self-Test": {
        ...
        "ja": "セルフテストを実行",
        "ko": "자체 테스트 실행",
        "fr": "Lancer l’autotest",
        "es": "Ejecutar autoprueba",
        "hi": "स्व-परीक्षण चलाएँ",
        "ru": "Запустить самопроверку",
    },
    "Open Licenses": {
        "zh-Hans": "打开许可证",
        "zh-Hant": "打開授權條款",
    ...
    "Terminal engine": {
        ...
        "ja": "ターミナルエンジン",
        "ko": "터미널 엔진",
        "fr": "Moteur de terminal",
        "es": "Motor de terminal",
        "hi": "टर्मिनल इंजन",
        "ru": "Движок терминала",
    },
    "Patches": {
    ...
    "Build details, a capability self-test and licenses: Help → Diagnostics…": {
        "zh-Hans": "构建详情、功能自检和许可证：帮助 → 诊断…",
        "zh-Hant": "建置詳細資訊、功能自我測試與授權條款：輔助說明 → 診斷…",
        "ja": "ビルドの詳細、機能のセルフテスト、ライセンス：ヘルプ → 診断…",
        "ko": "빌드 세부 정보, 기능 자체 테스트 및 라이선스: 도움말 → 진단…",
        "fr": "Détails de compilation, autotest des fonctions et licences : Aide → Diagnostic…",
        "es": "Detalles de compilación, autoprueba de funciones y licencias: Ayuda → Diagnóstico…",
        "hi": "बिल्ड विवरण, क्षमता स्व-परीक्षण और लाइसेंस: सहायता → निदान…",
        "ru": "Сведения о сборке, самопроверка возможностей и лицензии: Справка → Диагностика…",
    },
    "Check for Updates…": {
        "zh-Hans": "检查更新…",
        "zh-Hant": "檢查更新…",
